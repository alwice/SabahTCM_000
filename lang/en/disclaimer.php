...
<head>
	<?php
		...
		include("menu.php");
	?>
	<title>Disclaimer - SabahTCM</title>
</head>
<body>
	<div id="breadcrum">
	...
	<div id="body">
		<div class="content" style="text-align:justify;">	
			...
			<p>SabahTCM is not liable for any information provided on this Site with regard to recommendations regarding treatment for any health purposes. Herbal are not intended to treat, prevent or cure disease. Consult with a healthcare professional before starting any treatment. SabahTCM makes no guarantee or warranty with respect to any information provided.</p>
			<p>SabahTCM is not responsible for any issues that trigger from the information provided even SabahTCM has been advised of possibility of issues.</p>
			<p>These statements apply to SabahTCM by Neoh.</p>
		</div>
	</div>
	<?php
		include ("footer.php");
