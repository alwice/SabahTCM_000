...
<body>
	<div id="breadcrumb">
		...
		?>
				...
				<a href="add_comment.php?id=<?php echo $id;?>"><i class="icon-question icon-large"></i>&nbsp;回答</a>&nbsp;&nbsp;
		<?php
			}/*end breadcrumb 问题*/
		...
		?>
				...
				<a href="topic_view.php?id=<?php echo $id;?>"><i class="icon-question icon-large"></i>&nbsp;<?php echo $topic;?></a>&nbsp;&nbsp;>
				<a href="add_comment.php?id=<?php echo $id;?>"><i class="icon-question icon-large"></i>&nbsp;发表评论</a>&nbsp;&nbsp;
		<?php
		...
		<div id="small_window">
			...
			<form id="topic" class="form-inline" method="POST" action="" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label>评论：</label>
					<textarea type="text-box" class="form-control" name="comment" placeholder="评论" required /></textarea>
				</div>
				</br><span class="form_break"></br></span>
				<p>评论只有在被管理员审核后才会呈现在论坛里。</p>
				</br>
				<!--submit button-->
				<div class="controls">
