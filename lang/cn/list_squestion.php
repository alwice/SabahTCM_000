<select type="text" data-toggle="tooltip" data-placement="right" class="form-control" name="squestion" id="squestion" required>
	...
	<option value="What was the hospital where you were born?">What was the hospital where you were born?</option>
