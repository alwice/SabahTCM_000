...
?>
	...
	<div id="header">
		...
		?>
				...
				<p style="text-align: right;font-size: 15">欢迎， &nbsp;<i class="icon-user icon-large"></i>
		...
		?>
				...
				<p style="text-align: right;font-size: 15"><a href="login.php"><i class="icon-user icon-large"></i>&nbsp;登入</a>&nbsp;&nbsp;|||
		...
		<a href="../en/<?php echo $_SESSION['pages'];?>"><img style="" src="../../images/en.ico">&nbsp;EN</a></p>
		...
		<div>	
			...
			<div id="logo" style=" text-align:center; padding: 40px 0px 0px 0px ;padding-left:15px;">
